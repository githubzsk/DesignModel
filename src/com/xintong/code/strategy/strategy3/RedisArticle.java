...
public enum RedisArticle implements Article {
    ...
    ITEM4(4,"4什么是RESP协议"),
    ITEM5(5,"5Redis单线程为什么这么快"),
    ITEM6(6,"6Redis单线程如何处理客户端并发连接"),
    ITEM7(7,"7Redis为什么是单线程，一定是单线程吗？"),
    ITEM8(8,"8Redis为什么不适用多线程"),
    ITEM9(9,"9什么是IO多路复用"),
    ITEM10(10,"10哨兵如何检查Redis实例"),
    ITEM11(11,"11哨兵之间如何通讯？"),
    ITEM12(12,"12哨兵之间Leader选举机制"),
