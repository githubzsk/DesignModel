...
public enum BaseCollectionArticle implements Article {
    ...
    ITEM14(14,"14为什么要重写hashcode和equals/重写equals为什么一定要重写hashCode"),//1
    ITEM15(15,"15遍历HashMap"),//1
    ITEM16(16,"16对象做HashMap的Key值，需要注意什么？"),//1
    ITEM17(17,"17HashMap的理解"),//1
    ITEM18(18,"18hashcode的作用"),//
    ...
    ITEM24(24,"24HashMap的默认负载因子为什么是0.75，初始容量为什么是16"),//1
    ITEM25(25,"25JDK8中HashMap为什么引入红黑树？"),//1
