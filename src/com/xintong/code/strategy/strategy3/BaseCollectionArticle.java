...
public enum BaseCollectionArticle implements Article {
    ...
    ITEM1(1,"1集合的分类"),
    ITEM2(2,"2集合和数组的区别"),//1
    ITEM3(3,"3Comparable 和 Comparator"),
    ...
    ITEM10(10,"10List和Set"),//1
    ITEM11(11,"11集合排序  arraylist排序"),//1
    ITEM12(12,"12ArrayList去重"),
    ITEM13(13,"13为什么要有迭代器"),//1
    ITEM14(14,"14为什么要重写hashcode和equals/重写equals为什么一定要重写hashCode"),
    ITEM15(15,"15遍历HashMap"),//1
    ...
    ITEM22(22,"22HashMap的resize()扩容方法"),
    ...
    ITEM28(28,"28为什么大于8链表转红黑树，而不是7或者9"),//1
    ITEM29(29,"29jdk7并发条件下HashMap存在什么问题"),//1
